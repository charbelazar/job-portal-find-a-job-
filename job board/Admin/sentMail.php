          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li ><a href="mailbox.php"><i class="fa fa-inbox"></i> Inbox</li>
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <?php 
                  ...
                  $sql="select count(message_ID) from messages where sender_ID=$user_id";
                ...
                <table class="table table-hover table-striped">
                  ...
                  if($nbrows>0){
                    while( $row=mysqli_fetch_array($result)){
                      $receiver_id=$row[2];
                      $sql="select user_type_ID,email from user_account where ID_user=$receiver_id";
                      $result2=mysqli_query($con,$sql);
                      $row2=mysqli_fetch_array($result2);
                      $user_type=$row2[0];
                      if($user_type == 2 ){
                        $sql="select first_Name,last_name from jobseeker_profile where ID_user=$receiver_id ";
                        ...
                        $last_name=$row3[1];
                           ...
                           if($user_type == 3 ){
                            $sql="select company_name from company_profile where ID_user=$receiver_id ";
                            $result3=mysqli_query($con,$sql);
                            $row3=mysqli_fetch_array($result3);
                            $company_name=$row3[0];
                    ...
                    if($user_type ==2){
                      echo "<td class='mailbox-name'><a href='read_mail.php?message_id=".$row[0]."&Fname=".$first_name."&Lname=".$last_name."&text=".$row['Text']."&email=".$row2['email']."&date=".$row['Time']."&type=sent'>".$first_name." ".$last_name."</a></td>";
                    }
                    if($user_type==3){
                      echo "<td class='mailbox-name'><a href='read_mail.php??message_id=".$row[0]."&comapny_name=".$company_name."&text=".$row['Text']."&email=".$row2['email']."&date=".$row['Time']."&type=sent'>".$company_name."</a></td>";
                    }
                 
                    echo" <td class='mailbox-subject'>".$row['Text']."</td>";
