...
<script src="jobseeker_list.js"></script>
<script src="jobseeker_search.js"></script>
<!-------------------------------------------------------------------------------------->
<!-------------------scroll table css------------------------------------------------------->
<style>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="breadcrumb-wrapper">
          <h2 class="product-title">Browse Jobseeker</h2>
          <ol class="breadcrumb">
            <li><a href="jobseeker-index.php"><i class="ti-home"></i> Home</a></li>
            <li class="current">Browse jobseeker</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="right-sideabr">
          <div class="widget widget-search">
            <h5 class="widget-title">Search For a Jobseeker</h5>
            <form action="#">
              <input id="jobseeker_keyword" list="jobseeker_list" class="form-control search" placeholder="Enter your keyword">
              <datalist id="jobseeker_list">
                 
              </datalist>
              <button id="btn_search_jobseeker" class="search-btn" type="button"><i class="fa fa-search"></i></button>
            </form>
          ...
          <div class="inner-box">
            ...
            <h4>Gender :</h4>
            <ul class="lest item">
              <select id="select_gender" class=" chosen-select  " tabindex="2">
            ...
            <h4>Nationality :</h4>
            <ul class="lest item">
              <select id="select_nationality" class=" chosen-select  " tabindex="2">
                <option selected>-- select one --</option>
      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
        <div class="job-alerts-item candidates">
          <div class="table-wrapper-scroll-y">
            <table id="jobseeker_table" class="table">
            <h3 id="jobseeker_nb" class="alerts-title">JOBSEEKER :</h3>
              <tr>
                <td>&nbsp</td>
              </tr>
