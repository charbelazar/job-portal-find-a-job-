      ...
      <div class="row">
            ...
            <p hidden id="usertypeid"><?php echo $usertype ; ?> </p>
               <div class="inner-box">
                  ...
                  <ul class="lest item">
                     ...
                     <li><a href="inbox.php?<?php if($usertype==2){echo "usertype=2";}else{echo "usertype=3";}?>">Inbox <!--<span class="notinumber">2</span>--></a></li>
         ...
         <div class="col-md-8 col-sm-8 col-xs-8">
            <div id="innerbox" class="inner-box my-resume">
               ...
               <h3 class="alerts-title">Received Messages</h3>
               _________________________________________________________________________________________________________

               <div class="table-wrapper-scroll-y ">
              <?php
              
              $selectmg = "select distinct m.timestamp, v.email, m.message FROM  messages m, user_account v WHERE v.ID_user = m.sender_ID and m.receiver_ID=$userid order by m.timestamp DESC";
              $result = mysqli_query($con, $selectmg);
              ...
              while ( $row = mysqli_fetch_array($result) ) {
                 echo "<tr>
                 <td style='width:100px; height:40px;'>$row[0]</td><td style='width:350px;'>$row[1]</td><td style='width:350px;'>$row[2]</td><td style='width:25px;'><a style='background-color:red ; color: white; padding: 1em 1.5 em; text-transform:uppercase;' href='newemail.php?usertype=".$usertype."&email=".$row[1]."'  >Reply</a></td></tr>" ; 
              }
              echo "</table>" ;
              ?>
               </div>
               ...
               echo  "<input type='button'  id='emptyinbx' name='emptyinbx' onclick='emptyinbox()' class='btn btn-common' value='Delete all messages'>" ;
...
function emptyinbox()
 {
     ...
     var idr =  document.getElementById("userid").innerHTML ; 
     window.location.href = "emptyinbox.php?idr="+idr+"&usertype="+usertype ; 
